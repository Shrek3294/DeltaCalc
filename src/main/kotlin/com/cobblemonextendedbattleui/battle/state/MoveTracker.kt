...
object MoveTracker {
    ...
    fun getRevealedMovesByName(pokemonName: String, preferAlly: Boolean? = null): Set<String> {
        return PokemonRegistry.resolvePokemonUuids(pokemonName, preferAlly)
            .flatMap { getRevealedMoves(it) }
